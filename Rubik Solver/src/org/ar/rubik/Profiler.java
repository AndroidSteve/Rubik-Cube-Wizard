...
public class Profiler {
	...
	public Mat drawTimeConsumptionMetrics(Mat image, StateModel stateModel) {
    	...
    	Imgproc.rectangle(image, new Point(0, 0), new Point(500, 720), ColorTileEnum.BLACK.cvColor, -1);
		int index = 0;
		...
		if(framesPerSecondTimeStamp > 0)  {
		    ...
		    Imgproc.putText(image, string, new Point(50, 100), Constants.FontFace, 2, ColorTileEnum.WHITE.cvColor, 2);
		}
        framesPerSecondTimeStamp = newTimeStamp;


		Imgproc.putText(image, "Event    Time  Min", new Point(50, 150), Constants.FontFace, 2, ColorTileEnum.WHITE.cvColor, 2);
    ...
    private void renderAndIndex(Event endEvent, Event startEvent, Mat image, int index) {
    	...
    	if(eventSet.containsKey(endEvent) == false) {
    		Imgproc.putText(image, endEvent.toString() + ": NA", new Point(50, 200 + 50 * index), Constants.FontFace, 2, ColorTileEnum.WHITE.cvColor, 2);
    	}
    	...
    	// more quickly to the desired value.
    		...
    		Imgproc.putText(image, string, new Point(50, 200 + 50 * index), Constants.FontFace, 2, ColorTileEnum.WHITE.cvColor, 2);
    	}
