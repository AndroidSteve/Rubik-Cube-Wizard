...
public class OverlayGLCube {
	...
	public void draw(GL10 gl) {
		...
		gl.glDrawArrays(GL10.GL_LINE_STRIP, 0, frontOutlineVertices.length / 3);
		gl.glVertexPointer(3, GL10.GL_FLOAT, 0, topOutlineVertexBuffer);
		gl.glDrawArrays(GL10.GL_LINE_STRIP, 0, topOutlineVertices.length / 3);
		gl.glVertexPointer(3, GL10.GL_FLOAT, 0, leftOutlineVertexBuffer);
		gl.glDrawArrays(GL10.GL_LINE_STRIP, 0, leftOutlineVertices.length / 3);
